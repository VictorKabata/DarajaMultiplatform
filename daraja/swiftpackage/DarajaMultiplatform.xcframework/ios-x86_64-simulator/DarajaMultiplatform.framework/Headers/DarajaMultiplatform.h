...
@class DarajaMultiplatformDarajaEnvironment, DarajaMultiplatformDarajaToken, DarajaMultiplatformDarajaResult<__covariant T>, DarajaMultiplatformMpesaExpressResponse, DarajaMultiplatformDarajaTransactionType, DarajaMultiplatformQueryMpesaExpressResponse, DarajaMultiplatformDaraja, DarajaMultiplatformDarajaBuilder, DarajaMultiplatformKotlinThrowable, DarajaMultiplatformKotlinArray<T>, DarajaMultiplatformKotlinException, DarajaMultiplatformDarajaExceptionCompanion, DarajaMultiplatformDarajaException, DarajaMultiplatformDarajaTokenCompanion, DarajaMultiplatformMpesaExpressResponseCompanion, DarajaMultiplatformQueryMpesaExpressResponseCompanion, DarajaMultiplatformKotlinEnumCompanion, DarajaMultiplatformKotlinEnum<E>, DarajaMultiplatformC2BResponseType, DarajaMultiplatformDarajaIdentifierType, DarajaMultiplatformDarajaResultFailure, DarajaMultiplatformKotlinNothing, DarajaMultiplatformDarajaResultSuccess<__covariant T>, DarajaMultiplatformDarajaTransactionCode, DarajaMultiplatformKotlinx_serialization_coreSerializersModule, DarajaMultiplatformKotlinx_serialization_coreSerialKind;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("C2BResponseType")))
@interface DarajaMultiplatformC2BResponseType : DarajaMultiplatformKotlinEnum<DarajaMultiplatformC2BResponseType *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) DarajaMultiplatformC2BResponseType *canceled __attribute__((swift_name("canceled")));
@property (class, readonly) DarajaMultiplatformC2BResponseType *completed __attribute__((swift_name("completed")));
+ (DarajaMultiplatformKotlinArray<DarajaMultiplatformC2BResponseType *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<DarajaMultiplatformC2BResponseType *> *entries __attribute__((swift_name("entries")));
@end
