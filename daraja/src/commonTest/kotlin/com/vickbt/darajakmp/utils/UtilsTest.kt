...
class UtilsTest {
    ...
    @Test
    fun `getDarajaTimeStamp returns correct timestamp on double digit values`() = runTest {
        val currentDateTime =
    ...
    @Test
    fun `phone number starting with 07 is formatted correctly`() = runTest {
    ...
    @Test
    fun `phone number starting with 01 is formatted correctly`() = runTest {
    ...
    @Test
    fun `phone number starting with 254 is formatted correctly`() = runTest {
    ...
    @Test
    fun `phone number starting with plus 254 is formatted correctly`() = runTest {
        val phoneNumber = "+254714091301"
        val expectedResult = "254714091301"
    ...
    @Test
    fun `phone number less than 10 characters throws errors`() = runTest {
    ...
    @Test
    fun `phone number more than 10 characters throws errors`() = runTest {
    ...
    @Test
    fun `phone number with spaces are formatted correctly`() = runTest {
    ...
    @Test
    fun `time units with value less than ten are formatted correctly`() = runTest {
        val timeUnit = 1
    ...
    @Test
    fun `time units with value more than ten retain their formatting`() = runTest {
        val timeUnit = 11
